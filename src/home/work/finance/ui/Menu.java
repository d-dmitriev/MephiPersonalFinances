...
import static home.work.finance.ui.Console.printLineError;

public class Menu {
    static Scanner scanner = new Scanner(System.in);

    public static void loginMenu(UserService userService,
    ...
    private static void transactionsMenu(WalletService walletService, BudgetService budgetService, User currentUser) {
        while (true) {
            printHeader("Управление доходами и расходами:");
            printMenu("""
                    1. Добавить доход
                    2. Добавить расход
